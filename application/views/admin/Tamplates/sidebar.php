         ...
         <nav class="sidebar-nav">
             <ul id="sidebarnav">
                 <li class="sidebar-item pt-2">
                     <a class="sidebar-link waves-effect waves-dark sidebar-link dropdown-toggle" href="dashboard.html" aria-expanded="false">
                         <i class="far fa-clock" aria-hidden="true"></i>
                         <span class="hide-menu">Dashboard</span>
                     </a>
                 </li>
                 <li class="sidebar-item">
                     <a class="sidebar-link waves-effect waves-dark sidebar-link dropdown-toggle" data-bs-toggle="dropdown" href="profile.html" aria-expanded="false">
                         <i class="fa-solid fa-user-graduate"></i>
                         <span class="hide-menu">Guru</span>
                     </a>
                     <ul class="dropdown-menu ms-3 p-3">
                         <li><a href="<?= base_url(); ?>Guru">Guru</a></li>
                         <li><a href="<?= base_url(); ?>Mata_pelajaran">Mata Pelajaran</a></li>
